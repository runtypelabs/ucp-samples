...
<script src="https://cdn.jsdelivr.net/npm/@runtypelabs/persona@3.10.1/dist/install.global.js" data-config='{"apiUrl":"https://api.runtype.com","clientToken":"ct_test_01kp2sr6_6eaf2053b7ce962b8cedd04f6f17ffc6","parserType":"json","theme":{"palette":{"colors":{"primary":{"500":"#0F766E","600":"#0D6D64"},"gray":{"50":"#FAFAF9","100":"#F5F5F4","200":"#E7E5E4","500":"#78716C","900":"#1C1917"}},"typography":{"fontFamily":{"sans":"Manrope, system-ui, sans-serif"}},"radius":{"md":"6px","lg":"8px"}},"components":{"header":{"background":"#0F766E","titleForeground":"#FFFFFF","subtitleForeground":"rgba(255,255,255,0.8)","actionIconForeground":"rgba(255,255,255,0.9)","iconBackground":"rgba(255,255,255,0.15)","iconForeground":"#FFFFFF"}}},"launcher":{"enabled":true,"title":"UCP Shopping Agent","subtitle":"Buy flowers with AI over UCP","position":"bottom-right"},"features":{"showReasoning":true,"showToolCalls":true,"scrollToBottom":{"enabled":true,"iconName":"arrow-down","label":""},"toolCallDisplay":{"collapsedMode":"tool-name","activePreview":false,"grouped":true,"previewMaxLines":2,"expandable":true},"reasoningDisplay":{"activePreview":true,"previewMaxLines":3,"expandable":true}}}'></script>
